...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_estimators", default=os.environ["N_ESTIMATORS"])
    parser.add_argument("--min_samples_split", default=os.environ["MIN_SAMPLES_SPLIT"])
